...
export  function CreatePassword  (props:{ signUp: (password:string, email:string) => void, email:string,  setCurrentIndex: Dispatch<SetStateAction<number>>}){
    ...
    return(
    <div>
        <button className="p-2.5 bg-white w-9 h-9 border rounded-[5] " onClick={()=>{
